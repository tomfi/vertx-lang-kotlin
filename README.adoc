...
image:https://img.shields.io/badge/kotlin-1.5.0-blue.svg["Kotlin version badge",link="https://kotlinlang.org"]
image:https://img.shields.io/badge/kotlinx.coroutines-1.5.0-RC-blue.svg["Coroutines version badge",link="https://github.com/Kotlin/kotlinx.coroutines#kotlinxcoroutines"]
